...
void SRTN( int processCount)
{
    printf("SRTN Scheduler\n");
    ...
    struct minHeap *Running_Heap = createMinHeap(processCount);
    ...
    while(remainingProcesses>0)
    {
        ...
        if(!isEmpty(Running_Heap))
        {
            ...
            sendmsg.mtype = Running_Heap->harr[0]->pid;
            sendmsg.msg = 1;
